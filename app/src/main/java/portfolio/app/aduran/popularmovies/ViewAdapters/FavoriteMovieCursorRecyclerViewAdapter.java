 ...
 */
public class FavoriteMovieCursorRecyclerViewAdapter extends CursorRecyclerViewAdapter<MoviePosterViewHolder> {

    private final OnListFragmentInteractionListener mListener;
    private final Context mContext;

    public FavoriteMovieCursorRecyclerViewAdapter(OnListFragmentInteractionListener listener, Context context, Cursor cursor) {
